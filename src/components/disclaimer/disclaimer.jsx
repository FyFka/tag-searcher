...
export const Disclaimer = () => {
  ...
  return (
    <aside className="fixed bottom-2 md:bottom-14 right-3 left-3 w-auto md:left-auto md:right-12 xl:right-16 z-50 md:w-80 flex flex-col gap-4 p-4 rounded-2xl shadow-lg backdrop-blur-md bg-base-300/90 border-[color-mix(in_oklab,var(--color-base-content)_10%,transparent)] border">
      <button
