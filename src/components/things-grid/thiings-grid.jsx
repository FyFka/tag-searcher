...
export class ThiingsGrid extends Component {
  ...
  componentDidMount() {
    ...
    if (this.containerRef.current) {
      ...
      this.containerRef.current.addEventListener("touchmove", this.handleTouchMove, { passive: false });
    }
  }
  ...
  render() {
    ...
    return (
      <div
        ...
        className={`${className} absolute inset-0 touch-none overflow-hidden`}
        style={{
