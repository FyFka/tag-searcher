...
export default function Privacy() {
  return (
    <div className="px-1 md:px-0 py-4 max-w-4xl mx-auto">
      ...
      <h2 className="font-extrabold my-4 text-xl md:text-2xl font-mono">Interpretation and Definitions</h2>
      <h3 className="font-bold my-1.75 text-lg md:text-xl font-mono">Interpretation</h3>
      <p>
      ...
      <h3 className="font-bold my-1.75 text-lg md:text-xl font-mono">Definitions</h3>
      <div className="space-y-1">
        ...
        <ul className="list-disc pl-8 space-y-1">
          ...
          <li>
            <p>
              ...
              this Agreement) refers to Discord Server Tag Searcher.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of
      ...
      <h4 className="font-bold my-1.5 font-mono">Usage Data</h4>
      <div className="space-y-1">
      ...
      <h4 className="font-bold my-1.5 font-mono">Tracking Technologies and Cookies</h4>
      <div className="space-y-1">
        <p>
        ...
        <ul className="list-disc pl-8 space-y-1">
          <li>
            ...
            refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use
            some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use
            Cookies.
          </li>
          <li>
        ...
        <ul className="list-disc pl-8 space-y-1">
          <li className="space-y-1">
            ...
            <p>
              ...
              of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the
        ...
        <ul className="list-disc pl-8 space-y-1">
          ...
          <li className="space-y-1">
            ...
            <p>Administered by: Us</p>
            <p>
              Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details
              or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having
      ...
      <h3 className="font-bold my-1.75 text-lg md:text-xl font-mono">Use of Your Personal Data</h3>
      <div className="space-y-1">
        ...
        <ul className="list-disc pl-8 space-y-1">
          ...
          <li>
            <p>
              <strong>To manage Your Account:</strong> to manage Your registration as a user of the Service. The Personal Data You provide
              can give You access to different functionalities of the Service that are available to You as a registered user.
            </p>
          </li>
          <li>
            <p>
              <strong>For the performance of a contract:</strong> the development, compliance and undertaking of the purchase contract for
          ...
          <li>
            <p>
              ...
              communication, such as a mobile application's push notifications regarding updates or informative communications related to
              the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their
              implementation.
            </p>
          </li>
          <li>
            <p>
              <strong>To provide You</strong> with news, special offers and general information about other goods, services and events which
              we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such
              information.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              ...
              restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern
              or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is
        ...
        <ul className="list-disc pl-8 space-y-1">
          <li>
            <strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze
          ...
          <li>
            <strong>With other users:</strong> when You share personal information or otherwise interact in the public areas with other
      ...
      <h3 className="font-bold my-1.75 text-lg md:text-xl font-mono">Retention of Your Personal Data</h3>
      <div className="space-y-1">
        <p>
          ...
          will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are
      ...
      <h3 className="font-bold my-1.75 text-lg md:text-xl font-mono">Transfer of Your Personal Data</h3>
      <div className="space-y-1">
        <p>
      ...
      <h3 className="font-bold my-1.75 text-lg md:text-xl font-mono">Delete Your Personal Data</h3>
      <div className="space-y-1">
      ...
      <h3 className="font-bold my-1.75 text-lg md:text-xl font-mono">Disclosure of Your Personal Data</h3>
      <h4 className="font-bold my-1.5 font-mono">Business Transactions</h4>
      <p>
      ...
      <h4 className="font-bold my-1.5 font-mono">Law enforcement</h4>
      <p>
      ...
      <h4 className="font-bold my-1.5 font-mono">Other legal requirements</h4>
      <div className="space-y-1">
      ...
      <h3 className="font-bold my-1.75 text-lg md:text-xl font-mono">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="font-extrabold my-4 text-xl md:text-2xl font-mono">Children's Privacy</h2>
      <div className="space-y-1">
        <p>
      ...
      <h2 className="font-extrabold my-4 text-xl md:text-2xl font-mono">Links to Other Websites</h2>
      <div className="space-y-1">
        <p>
      ...
      <h2 className="font-extrabold my-4 text-xl md:text-2xl font-mono">Changes to this Privacy Policy</h2>
      <div className="space-y-1">
        <p>
      ...
      <h2 className="font-extrabold my-4 text-xl md:text-2xl font-mono">Contact Us</h2>
      <div className="space-y-1">
